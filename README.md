...
<p align="center">
  ...
  <a href="https://github.com/apex-freen/apex-mcp-esp32-c3-v6">GitHub</a>
</p>
...
# Clone the repo
git clone https://github.com/apex-freen/apex-mcp-esp32-c3-v6.git
cd apex-mcp-esp32-c3-v6
```

### 2. Pick a sub-project

```bash
cd apex-mcp-esp32-c3-v6-basic      # Basic version (recommended starting point)
```
...
```
apex-mcp-esp32-c3-v6/                    # Repository root
├── apex-mcp-esp32-c3-v6-basic/          # Sub-project: Basic reference implementation
...
|-------------|-------------|-----|
| [`apex-mcp-esp32-c3-v6-basic`](./apex-mcp-esp32-c3-v6-basic/) | Basic — full framework + sync/async examples | Learning & starting new projects |
...
| **apex-mcp-esp32-c3-v6** | Hardware firmware — ESP32-C3 (this repo) | [github.com/apex-freen/apex-mcp-esp32-c3-v6](https://github.com/apex-freen/apex-mcp-esp32-c3-v6) |
