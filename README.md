...
<p align="center">
  ...
  <a href="https://github.com/apex-freen/apex-esp32-c3-v6">GitHub</a>
</p>
...
**APEX** is an open-source **ESP32 agent-device firmware framework** — the hardware-side foundation of the [apex_mcp_bridge](https://github.com/apex-freen/apex-mcp-bridge) ecosystem, working together with [service-plugins](https://github.com/apex-freen/service-plugins) to form the full AI-to-hardware stack. This repository is the **ESP32-C3** variant.
...
# Clone the repo
git clone https://github.com/apex-freen/apex-esp32-c3-v6.git
cd apex-esp32-c3-v6
```
...
```bash
cd apex-esp32-c3-v6-basic      # Basic version (recommended starting point)
```
...
```
apex-esp32-c3-v6/                    # Repository root
├── apex-esp32-c3-v6-basic/          # Sub-project: Basic reference implementation
...
|-------------|-------------|-----|
| [`apex-esp32-c3-v6-basic`](./apex-esp32-c3-v6-basic/) | Basic — full framework + sync/async examples | Learning & starting new projects |
...
| **apex-esp32-c3-v6** | Hardware firmware — ESP32-C3 (this repo) | [github.com/apex-freen/apex-esp32-c3-v6](https://github.com/apex-freen/apex-esp32-c3-v6) |
| **apex-esp32-s3-v6** | Hardware firmware — ESP32-S3 | [github.com/apex-freen/apex-esp32-s3-v6](https://github.com/apex-freen/apex-esp32-s3-v6) |
